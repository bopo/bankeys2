...
class APITestUser(BaseAPITestCase):
    ...
    def test_user_validation(self):
        data = {
            'type': "invite",
            'data': {
                'uri': "/api/users/1/invite/",
            }
        }

        conten = self.post('/api/users/1/invite/', data=data, status_code=201)
        ...
        #         'type': "confirm",
        #         'data': {
        #             'uri': "/api/users/1/confirm/",
        #         }
        #     }
        #
        #     conten = self.post('/api/users/1/confirm/', data=data, status_code=201)
        #
        #     print conten
