...
class Relancement(models.Model):
    ...
    photo = models.ImageField(verbose_name=_(u'图片'), upload_to="goods", height_field='url_height',
    ...
    creation_time = models.DateTimeField(verbose_name=_(u'申请时间'), auto_now_add=True)
