...
from service.kernel.views.usbkeys import deposit, usbkey
...
# router.register(r'usbkey', UsbkeyViewSet, base_name='usbkey')
...
urlpatterns = (
    ...
    url(r'^usb/$', deposit, name='deposit'),
    url(r'^usbkey/$', usbkey, name='usbkey'),
)
