...
class UsersViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def invite(self, request, pk, *args, **kwargs):
        ...
        ret, _ = Contact.objects.get_or_create(owner_id=pk, friend_id=owner.pk)
        ret.status = ''
        ret.save()
    ...
    def confirm(self, request, pk, *args, **kwargs):
        owner = request.user
        ret1 = Contact.objects.filter(owner_id=owner.pk, friend_id=pk)
        ret2 = Contact.objects.filter(owner_id=pk, friend_id=owner.pk)
