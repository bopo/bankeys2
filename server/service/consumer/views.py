...
from service.consumer.models import Contact, CustomUser, Notice, Profile
from service.kernel.utils import MyDestroyModelMixin
from .serializers import AddFriendSerializer, AddressSerializer, AvatarSerializer, BankcardSerializer, \
    ContactDetailSerializer, ContactHideSerializer, ContactSerializer, ContainsSerializer, NickSerializer, \
    NoticeSerializer, ProfileSerializer, SettingsSerializer
from .utils import get_user_profile, get_user_settings
...
class AddressViewSet(viewsets.ModelViewSet, mixins.UpdateModelMixin, MyDestroyModelMixin):
...
class BankcardViewSet(viewsets.ModelViewSet, mixins.UpdateModelMixin, MyDestroyModelMixin,
